...
/**
 * 
 * 类名称：StringUtils    String工具
 * 类描述：主要对 StringUtils 的一些方法进行重写,达到更方便的使用   
 * 创建人：刘子亮
 * 创建时间：2018年5月17日 上午10:09:05      
 * @version  V1.0
 *
 */
public class StringUtils extends org.apache.commons.lang.StringUtils{
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(StringUtils.createPassword(password, salt, 2));
	}

...
@Controller
@RequestMapping(value="/commonContacts")
@Api(value = "commonContacts-API",tags={"常用联系人"})
public class TbCommonContactsController {
	...
	@ResponseBody
	@ApiOperation(value = "获取常用联系人列表",notes = "获取常用联系人列表")
	public ResultBean<TbCommonContacts> getCompanyList(

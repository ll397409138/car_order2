(function(a) {
	...
	var i = function(l, k) {
		...
		this.title = typeof k.title === "undefined" ? false : k.title; /*this.defaultTimeZone=(new Date).toString().split("(")[1].slice(0,-1);*/
	...
	var g = {
		...
		headTemplate: '<thead><tr><th class="prev"><img style="display:block;width:14px;height:14px;margin:0 auto;" src="../common/image/arrleft.png"/></th><th colspan="5" class="switch"></th><th class="next"><img style="display:block;width:14px;height:14px;margin:0 auto;" src="../common/image/arrright.png"/></th></tr></thead>',
		headTemplateV3: '<thead><tr><th class="prev"><img style="display:block;width:14px;height:14px;margin:0 auto;" src="../common/image/arrleft.png"/></th><th colspan="5" class="switch"></th><th class="next"><img style="display:block;width:14px;height:14px;margin:0 auto;" src="../common/image/arrright.png"/></th></tr></thead>',

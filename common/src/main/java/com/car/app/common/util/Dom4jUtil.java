...
public class Dom4jUtil {
     ...
     * @param doc
     */
    public static void getAllIterator(Document doc) {
        Element root = Dom4jUtil.getElement(doc);
        // 枚举所有子节点
     ...
     * @param fooName
     */
    public static void getFooIterator(Document doc, String fooName) {
        Element root = Dom4jUtil.getElement(doc);
        // 枚举名称为foo的节点
     ...
     * @param doc
     */
    public static void getAttributeIterator(Document doc) {
        Element root = Dom4jUtil.getElement(doc);
        // 枚举属性
     ...
     * @param doc
     */
    public static void getVisit(Document doc) {
        Element root = Dom4jUtil.getElement(doc);
        root.accept((Visitor) new Dom4jVisitorUtil());
    }
     ...
     * @throws DocumentException
     */
    public static void findLinks(Document doc) throws DocumentException {
     ...
     * @throws IOException
     */
    public static void simpleWrite(Document doc,String xml) throws IOException{
     ...
     * @throws IOException
     */
    public static void formatWrite(Document doc, String xml) throws IOException {
        // 指定文件
